...
const CoinDetailsPage = () => {
    ...
    return (
        <div className='coin-details-container'>
            ...
            {!loading && !error && (
                <>
                    <img src={coin.image.large} alt={coin.name} className='coin-details-page'/>
                    <p>{coin.description.en.split('. ')[0] + '.'}</p>
                    <div className='coin-details-info'>
                        <h3>Rank: #{coin.market_cap_rank}</h3>
                        {coin.market_data.current_price_usd && <h3>Current Price: ${coin.market_data.current_price_usd.toLocaleString()}</h3>}
                        ...
                        {coin.market_data.data_price_change_24h && <h4>24h Price Change: {coin.market_data.data_price_change_24h.toFixed(2)} ({
                        ...
                        <h4>All-Time High: {coin.market_data.ath.usd.toLocaleString()} 
                            on{' '}{new Date(coin.market_data.ath_date.usd).toLocaleString()}</h4>
                        <h4>All-Time Low: {coin.market_data.atl.usd.toLocaleString()} 
                            on{' '}{new Date(coin.market_data.atl_date.usd).toLocaleString()}</h4>    
